  ...
  return (
    ...
    >
      <motion.div
        ...
        className="h-full bg-white rounded-3xl p-8 border border-slate-200/80 shadow-sm hover:shadow-[0_16px_40px_rgba(15,23,42,0.12)] hover:border-indigo-100 transition-all duration-300"
      >
        <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-indigo-700 mb-6">
  ...
  return (
    ...
    >
      <div className="w-7 h-7 rounded-lg bg-indigo-50 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-indigo-100 transition-colors">
        <Icon className="w-3.5 h-3.5 text-indigo-800" strokeWidth={2} />
      </div>
      <div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className="mb-14 max-w-4xl">
          <motion.h2
            ...
            className="text-balance text-3xl sm:text-4xl lg:text-5xl font-bold tracking-[-0.03em] text-slate-950 leading-tight"
          >
        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm px-6 py-2">
